...
headers = [
    ...
    "a4_evidence_audit_record_count",
    "a4_confirmed_family_candidate_count",
    "a4_provisional_family_candidate_count",
    ...
    for line in results_path.read_text(encoding="utf-8").splitlines():
        ...
        rows.append(
            [
                ...
                metrics.get("a4_evidence_audit_record_count", 0),
                metrics.get("a4_confirmed_family_candidate_count", 0),
                metrics.get("a4_provisional_family_candidate_count", 0),
