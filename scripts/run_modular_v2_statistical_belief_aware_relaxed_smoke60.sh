...
BRAIN_CONFIG_PATH_VALUE="${BRAIN_CONFIG_PATH_VALUE:-${PROJECT_ROOT}/configs/brain_benchmark_modular_v2_statistical_belief_aware_relaxed.yaml}"
CASES_FILE="${CASES_FILE:-${PROJECT_ROOT}/test_outputs/simulator_cases/graph_cases_20260502_role_qc/smoke60/cases.jsonl}"
OUTPUT_ROOT="${OUTPUT_ROOT:-${PROJECT_ROOT}/test_outputs/simulator_replay/benchmark_modular_v2_statistical_belief_aware_relaxed_smoke60}"
