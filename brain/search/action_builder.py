...
from ..state import A3VerificationResult, HypothesisScore, MctsAction, QuestionCandidate, SessionState
...
class ActionBuilder:
    ...
    def build_verification_actions(
        ...
        # ActionBuilder 把 R2 节点翻译成真正可选的提问动作，并在这里融合成本、区分度和 repair 推荐信号。
    ...
    def build_a3_verification_result(
        ...
        # A3 结果是给外层展示/提问用的收口对象，把内部动作和患者可读问题文本绑在一起。
