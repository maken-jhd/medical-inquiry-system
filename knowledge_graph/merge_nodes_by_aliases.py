...
ALIAS_FILE_TO_LABEL = {
    ...
    "diagnostic_criterion_aliases.json": "DiagnosticCriterion",
    "disease_aliases.json": "Disease",
    "disease_phase_aliases.json": "DiseasePhase",
    "drug_class_aliases.json": "DrugClass",
    "lab_finding_aliases.json": "LabFinding",
    "lab_test_aliases.json": "LabTest",
    "management_action_aliases.json": "ManagementAction",
    "medication_aliases.json": "Medication",
    ...
    "prevention_strategy_aliases.json": "PreventionStrategy",
    ...
    "treatment_regimen_aliases.json": "TreatmentRegimen",
